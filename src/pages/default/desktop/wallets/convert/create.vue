<template>
  <div>
    <div class="row justify-end q-my-xl q-px-xl">
      <q-btn @click="$router.push({name:'WalletsConvertRecord'})" class="bg-grey-2" :label="$t('convertRecord')"
             unelevated></q-btn>
    </div>
    <div class="row justify-center q-pa-xl">
      <div class="column">
        ...
        <q-card class="relative-position bg-grey-2 rounded-borders" flat>
          <q-card-section class="text-grey-7 q-py-md q-px-xs">
            <div class="row items-center no-wrap">
              <q-btn @click="showAssetsPopup = true;AssetsType=ConvertSideFrom" class="col-5" flat rounded no-caps
                     size="md">
              ...
              <q-input v-model="convertParams.money" dense borderless class="q-px-lg">
        ...
        <div class="row justify-center q-my-lg">
          <q-btn @click="invertFunc" style="width: 25px;height: 25px" round flat icon="swap_vert"
                 color="primary"></q-btn>
        </div>
        ...
        <!-- 预览按钮 -->
        <div class="q-my-xl">
          <q-btn @click="convertInfoFunc" no-caps rounded unelevated size="lg" color="primary"
    ...
    <q-dialog v-model="showAssetsPopup">
      <q-card class="q-py-md relative-position" style="width: 340px;">
        <q-card-section class="q-pa-none">
          <div class="text-h6 text-center">{{ $t('currencies') }}</div>
          <q-btn icon="close" color="grey" class="absolute-bottom-right q-mr-md" flat round dense
