  ...
  <div>
    <div class="q-mt-lg q-px-lg">
      <q-form>
        ...
        <q-btn @click="updatePasswordFunc(secretKeyType, $router.back)" size="lg" class="full-width q-mb-xl" unelevated
               rounded no-caps color="primary"
               :label="$t('submit')" />
      </q-form>
    </div>
  </div>
...
import { secretKeyType, userInfoCommon } from 'src/pages/common/users/info';
import { ref } from 'vue';
