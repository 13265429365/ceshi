<template>
  <div class="q-pa-md bg-white q-gutter-y-md">
    <!-- 输入账号 -->
    <div>
    ...
    <div>
      ...
      <div class="text-right q-mt-sm">
        <div class="text-grey">
          <span class="q-mr-sm">
            {{ transferParams.assetsId > 0 ? $t('availableAssets') : $t('availableBalance') }}
          </span>
...
emit('update', {
  ...
  right: {
    callback: () => {
      $router.push({ name: 'WalletsTransferRecord' });
    },
    icon: 'o_wysiwyg'
  },
})
