...
// node_modules/qrcode-svg-ts/dist/index.min.js
var require_index_min = __commonJS({
  "node_modules/qrcode-svg-ts/dist/index.min.js"(exports, module) {
    ...
    QR8bitByte.prototype = { getLength: function(t) {
      return this.parsedData.length;
    }, write: function(t) {
      for (var e = 0, r = this.parsedData.length; e < r; e++) t.put(this.parsedData[e], 8);
    } }, QRCodeModel.prototype = { addData: function(t) {
      ...
      this.make();
      for (var n = 0; n < this.modules.length; n++) for (var i2 = 1 * n, s = 0; s < this.modules[n].length; s++) {
        var a = 1 * s;
        this.modules[n][s] && (o.beginFill(0, 100), o.moveTo(a, i2), o.lineTo(a + 1, i2), o.lineTo(a + 1, i2 + 1), o.lineTo(a, i2 + 1), o.endFill());
      }
      return o;
      ...
      for (var t = QRUtil.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) for (var r = 0; r < t.length; r++) {
        var o = t[e], n = t[r];
        if (null == this.modules[o][n]) for (var i2 = -2; i2 <= 2; i2++) for (var s = -2; s <= 2; s++) this.modules[o + i2][n + s] = -2 == i2 || 2 == i2 || -2 == s || 2 == s || 0 == i2 && 0 == s;
      }
      ...
      for (var r = this.errorCorrectLevel << 3 | e, o = QRUtil.getBCHTypeInfo(r), n = 0; n < 15; n++) {
        var i2 = !t && 1 == (o >> n & 1);
        n < 6 ? this.modules[n][8] = i2 : n < 8 ? this.modules[n + 1][8] = i2 : this.modules[this.moduleCount - 15 + n][8] = i2;
      }
      for (n = 0; n < 15; n++) {
        i2 = !t && 1 == (o >> n & 1);
        n < 8 ? this.modules[8][this.moduleCount - n - 1] = i2 : n < 9 ? this.modules[8][15 - n - 1 + 1] = i2 : this.modules[8][15 - n - 1] = i2;
      }
      this.modules[this.moduleCount - 8][8] = !t;
    }, mapData: function(t, e) {
      for (var r = -1, o = this.moduleCount - 1, n = 7, i2 = 0, s = this.moduleCount - 1; s > 0; s -= 2) for (6 == s && s--; ; ) {
        for (var a = 0; a < 2; a++) if (null == this.modules[o][s - a]) {
          var h = false;
          i2 < t.length && (h = 1 == (t[i2] >>> n & 1)), QRUtil.getMask(e, o, s - a) && (h = !h), this.modules[o][s - a] = h, -1 == --n && (i2++, n = 7);
        }
      ...
      for (var o = QRRSBlock.getRSBlocks(t, e), n = new QRBitBuffer(), i2 = 0; i2 < r.length; i2++) {
        var s = r[i2];
        n.put(s.mode, 4), n.put(s.getLength(), QRUtil.getLengthInBits(s.mode, t)), s.write(n);
      }
      var a = 0;
      for (i2 = 0; i2 < o.length; i2++) a += o[i2].dataCount;
      if (n.getLengthInBits() > 8 * a) throw new Error("code length overflow. (" + n.getLengthInBits() + ">" + 8 * a + ")");
      for (n.getLengthInBits() + 4 <= 8 * a && n.put(0, 4); n.getLengthInBits() % 8 != 0; ) n.putBit(false);
      for (; !(n.getLengthInBits() >= 8 * a || (n.put(QRCodeModel.PAD0, 8), n.getLengthInBits() >= 8 * a)); ) n.put(QRCodeModel.PAD1, 8);
      return QRCodeModel.createBytes(n, o);
    }, QRCodeModel.createBytes = function(t, e) {
      for (var r = 0, o = 0, n = 0, i2 = new Array(e.length), s = new Array(e.length), a = 0; a < e.length; a++) {
        var h = e[a].dataCount, l = e[a].totalCount - h;
        o = Math.max(o, h), n = Math.max(n, l), i2[a] = new Array(h);
        for (var u = 0; u < i2[a].length; u++) i2[a][u] = 255 & t.buffer[u + r];
        r += h;
        var d = QRUtil.getErrorCorrectPolynomial(l), g = new QRPolynomial(i2[a], d.getLength() - 1).mod(d);
        s[a] = new Array(d.getLength() - 1);
        for (u = 0; u < s[a].length; u++) {
          var f = u + g.getLength() - s[a].length;
          s[a][u] = f >= 0 ? g.get(f) : 0;
        }
      }
      var c = 0;
      for (u = 0; u < e.length; u++) c += e[u].totalCount;
      var R = new Array(c), m = 0;
      for (u = 0; u < o; u++) for (a = 0; a < e.length; a++) u < i2[a].length && (R[m++] = i2[a][u]);
      for (u = 0; u < n; u++) for (a = 0; a < e.length; a++) u < s[a].length && (R[m++] = s[a][u]);
      return R;
    };
    for (QRMode = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 }, QRErrorCorrectLevel = { L: 1, M: 0, Q: 3, H: 2 }, QRMaskPattern = { PATTERN000: 0, PATTERN001: 1, PATTERN010: 2, PATTERN011: 3, PATTERN100: 4, PATTERN101: 5, PATTERN110: 6, PATTERN111: 7 }, QRUtil = { PATTERN_POSITION_TABLE: [[], [6, 18], [6, 22], [6, 26], [6, 30], [6, 34], [6, 22, 38], [6, 24, 42], [6, 26, 46], [6, 28, 50], [6, 30, 54], [6, 32, 58], [6, 34, 62], [6, 26, 46, 66], [6, 26, 48, 70], [6, 26, 50, 74], [6, 30, 54, 78], [6, 30, 56, 82], [6, 30, 58, 86], [6, 34, 62, 90], [6, 28, 50, 72, 94], [6, 26, 50, 74, 98], [6, 30, 54, 78, 102], [6, 28, 54, 80, 106], [6, 32, 58, 84, 110], [6, 30, 58, 86, 114], [6, 34, 62, 90, 118], [6, 26, 50, 74, 98, 122], [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104, 130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114, 142], [6, 34, 62, 90, 118, 146], [6, 30, 54, 78, 102, 126, 150], [6, 24, 50, 76, 102, 128, 154], [6, 28, 54, 80, 106, 132, 158], [6, 32, 58, 84, 110, 136, 162], [6, 26, 54, 82, 110, 138, 166], [6, 30, 58, 86, 114, 142, 170]], G15: 1335, G18: 7973, G15_MASK: 21522, getBCHTypeInfo: function(t) {
      ...
      for (var e = t.getModuleCount(), r = 0, o = 0; o < e; o++) for (var n = 0; n < e; n++) {
        for (var i2 = 0, s = t.isDark(o, n), a = -1; a <= 1; a++) if (!(o + a < 0 || e <= o + a)) for (var h = -1; h <= 1; h++) n + h < 0 || e <= n + h || 0 == a && 0 == h || s == t.isDark(o + a, n + h) && i2++;
        i2 > 5 && (r += 3 + i2 - 5);
      }
    ...
    }, EXP_TABLE: new Array(256), LOG_TABLE: new Array(256) }, i = 0; i < 8; i++) QRMath.EXP_TABLE[i] = 1 << i;
    var QRMode;
    ...
    QRPolynomial.prototype = { get: function(t) {
      return this.num[t];
    }, getLength: function() {
      ...
      for (var o = r.length / 3, n = [], i2 = 0; i2 < o; i2++) for (var s = r[3 * i2 + 0], a = r[3 * i2 + 1], h = r[3 * i2 + 2], l = 0; l < s; l++) n.push(new QRRSBlock(a, h));
      return n;
    ...
    }, QRBitBuffer.prototype = { get: function(t) {
    ...
    function QRCodeSVG(t) {
      if (this.options = { padding: 0, width: 256, height: 256, typeNumber: 4, color: "#000000", background: "#ffffff", ecl: "H", join: true }, "string" == typeof t && (t = { content: t }), t) for (var e in t) this.options[e] = t[e];
      ...
      var r = this.options.content, o = function(t2, e2) {
        for (var r2 = function(t3) {
          var e3 = encodeURI(t3).toString().replace(/\%[0-9a-fA-F]{2}/g, "a");
          return e3.length + (e3.length != t3 ? 3 : 0);
        }(t2), o2 = 1, n2 = 0, i2 = 0, s = QRCodeLimitLength.length; i2 <= s; i2++) {
          var a = QRCodeLimitLength[i2];
          if (!a) throw new Error("Content too long: expected " + n2 + " but got " + r2);
          switch (e2) {
            case "L":
              n2 = a[0];
              break;
            ...
            case "H":
              ...
              break;
            default:
              throw new Error("Unknwon error correction level: " + e2);
          }
          if (r2 <= n2) break;
          o2++;
        }
        if (o2 > QRCodeLimitLength.length) throw new Error("Content too long");
        return o2;
      }(r, this.options.ecl), n = function(t2) {
        switch (t2) {
          case "L":
          ...
          default:
            throw new Error("Unknwon error correction level: " + t2);
        }
      }(this.options.ecl);
      this.qrcode = new QRCodeModel(o, n), this.qrcode.addData(r), this.qrcode.make(), this.modules = this.qrcode.modules;
    }
    QRCodeSVG.prototype.svg = function(t) {
      var e = this.options || {}, r = this.qrcode.modules;
      void 0 === t && (t = { container: e.container || "svg" });
      for (var o = void 0 === e.pretty || !!e.pretty, n = o ? "  " : "", i2 = o ? "\r\n" : "", s = e.width, a = e.height, h = r.length, l = s / (h + 2 * e.padding), u = a / (h + 2 * e.padding), d = void 0 !== e.join && !!e.join, g = void 0 !== e.swap && !!e.swap, f = void 0 === e.xmlDeclaration || !!e.xmlDeclaration, c = void 0 !== e.predefined && !!e.predefined, R = c ? n + '<defs><path id="qrmodule" d="M0 0 h' + u + " v" + l + ' H0 z" style="fill:' + e.color + ';shape-rendering:crispEdges;" /></defs>' + i2 : "", m = n + '<rect x="0" y="0" width="' + s + '" height="' + a + '" style="fill:' + e.background + ';shape-rendering:crispEdges;"/>' + i2, p = "", v = "", Q = 0; Q < h; Q++) for (var E = 0; E < h; E++) {
        if (r[E][Q]) {
          var M = E * l + e.padding * l, w = Q * u + e.padding * u;
          if (g) {
            var C = M;
            M = w, w = C;
          }
          if (d) {
            var B = l + M, P = u + w;
            M = Number.isInteger(M) ? Number(M) : M.toFixed(2), w = Number.isInteger(w) ? Number(w) : w.toFixed(2), B = Number.isInteger(B) ? Number(B) : B.toFixed(2), v += "M" + M + "," + w + " V" + (P = Number.isInteger(P) ? Number(P) : P.toFixed(2)) + " H" + B + " V" + w + " H" + M + " Z ";
          } else p += c ? n + '<use x="' + M.toString() + '" y="' + w.toString() + '" href="#qrmodule" />' + i2 : n + '<rect x="' + M.toString() + '" y="' + w.toString() + '" width="' + l + '" height="' + u + '" style="fill:' + e.color + ';shape-rendering:crispEdges;"/>' + i2;
        }
      }
      d && (p = n + '<path x="0" y="0" style="fill:' + e.color + ';shape-rendering:crispEdges;" d="' + v + '" />');
      var L = "";
      switch (t.container) {
        case "svg":
          f && (L += '<?xml version="1.0" standalone="yes"?>' + i2), L += '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="' + s + '" height="' + a + '">' + i2, L += R + m + p, L += "</svg>";
          break;
        case "svg-viewbox":
          f && (L += '<?xml version="1.0" standalone="yes"?>' + i2), L += '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 ' + s + " " + a + '">' + i2, L += R + m + p, L += "</svg>";
          break;
        case "g":
          L += '<g width="' + s + '" height="' + a + '">' + i2, L += R + m + p, L += "</g>";
          break;
        default:
          L += (R + m + p).replace(/^\s+/, "");
      }
    ...
    var Platform = { isBrowser: "undefined" != typeof window && void 0 !== window.document, isNode: "undefined" != typeof process && null != process.versions && null != process.versions.node, isWebWorker: "object" == typeof self && self.constructor && "DedicatedWorkerGlobalScope" === self.constructor.name, isJsDom: "undefined" != typeof window && "nodejs" === window.name || "undefined" != typeof navigator && (navigator.userAgent.includes("Node.js") || navigator.userAgent.includes("jsdom")), isDeno: "undefined" != typeof Deno && void 0 !== Deno.core };
    QRCodeSVG.prototype.save = function(file) {
      function requireModule(name) {
        if (Platform.isNode) try {
      ...
      return new Promise((t, e) => {
        requireModule("fs").then((r) => {
          var o = this.svg();
          r.writeFile(file, o, function(r2) {
            r2 ? e(r2) : t(file);
          });
        }).catch(e);
      });
    }, QRCodeSVG.prototype.toDataURL = function() {
      var t = this.svg();
      return "data:image/svg+xml;utf8," + encodeURIComponent(t);
    }, "undefined" != typeof module && (module.exports = QRCodeSVG);
  }
});
export default require_index_min();
/*! Bundled license information:

qrcode-svg-ts/dist/index.min.js:
  (*! qrcode-svg-ts v1.4.0 | https://github.com/shlyren/qrcode-svg-ts | MIT license *)
*/
//# sourceMappingURL=qrcode-svg-ts.js.map
